...
const SkeletonFour = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Image
          src="https://miro.medium.com/v2/resize:fit:378/1*y6zvdl68fA-5nd9v-StFMg.png"
          alt="avatar"
          height="100"
          width="100"
          className="rounded-full h-10 w-10"
    ...
    >
      ...
      >
        ...
        <p className="text-xs text-neutral-500">
          Can we write our node js or react code and deploy it also ....
        </p>
      </motion.div>
      <motion.div
        variants={variantsSecond}
      ...
      >
        <p className="text-xs text-neutral-500">Yupp !!</p>
        <div className="h-6 w-6 rounded-full bg-gradient-to-r from-pink-500 to-violet-500 flex-shrink-0" />
      </motion.div>
    </motion.div>
  );
  ...
  
  {
    ...
    description: (
      <span className="text-sm">
        Here is list of the supported languages and frameworks.
      </span>
    ),
    header: <SkeletonFour />,
